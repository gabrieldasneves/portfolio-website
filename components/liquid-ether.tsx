  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(args?: {
        ...
        const cellScale = (props.cellScale || new THREE.Vector2(1, 1)) as THREE.Vector2
    ...
    class Output {
      ...
      constructor() {
        ...
        this.output = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), mat)
    ...
    class WebGLManager {
      ...
      constructor(props: WebGLManager['props']) {
        ...
        this.autoDriver = new AutoDriver(Mouse, this as AutoDriverManager, {
    ...
    const applyOptionsFromProps = () => {
      const w = webglRef.current
      if (!w?.output?.simulation) return
      const sim = w.output.simulation
      ...
      if (resolution !== prevRes && typeof sim.resize === 'function') {
        sim.resize()
      }
    }
